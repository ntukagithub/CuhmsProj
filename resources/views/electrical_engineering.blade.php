...
<div id="borderAnimation" class="w-[1000px] border border-gray-600 mx-auto mt-5 p-4 py-10 rounded relative">
  <h1 class="text-center pt-3 text-3xl font-extrabold text-yellow-500 animate-bounce">OUR ELECTRICAL ENGINEERING HUB</h1>
...
<a href="{{route('electrical_engineeringposts')}}" >
...
<a href="{{route('electrical_engineeringqn')}}" >
