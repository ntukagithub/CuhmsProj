...
<div id="borderAnimation" class="w-[1000px] border border-gray-600 mx-auto mt-5 p-4 py-10 rounded relative">
  <h1 class="text-center pt-3 text-3xl font-extrabold text-yellow-500 animate-bounce">OUR INFORMATION TECHNOLOGY HUB</h1>
...
<div class="w-[1000px] mx-auto flex   items-center gap-5 mt-[20px] text-white pl-2">
<a href="{{ url('chatify') }}" >
