...
<h1 class="text-white text-center py-2 text-xl font-bold">WELCOME TO OURCLINICAL MEDICINE DASHBOARD</h1>
<div class="max-w-[500px] mx-auto flex  items-center gap-5 mt-6 text-white">
  ...
  <div class="border border-yellow-500 py-2 px-5 w-[170px] rounded-lg text-center hover:bg-yellow-500 hover:text-white hover:font-bold hover:cursor-pointer duration-300"> <a href="{{route('clinical_medicineposts')}}"> <i class="fa-solid fa-bullhorn pr-2 text-white hover:text-gray-900 "></i>Posts</a></div>
  <a href="{{route('clinical_medicineqn')}}"><div class="border border-yellow-500 py-2 px-5 w-[170px] rounded-lg text-center hover:bg-yellow-500 hover:text-white hover:font-bold hover:cursor-pointer duration-300"> <i class="fa-solid fa-circle-question pr-2 text-white hover:text-gray-900 "></i>Ask Me</div></a>
</div>  
